...
class Tool:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "approval_reason": self.metadata.approval_reason,
        }
...
class ToolRegistry:
    ...
    def get_shared_tools(self) -> List[Tool]:
        ...
        with self._lock:
            return [
                self._tools[name] for name in self._shared_tools if name in self._tools
            ]
    ...
    def search_tools(
        ...
        with self._lock:
            ...
            for tool in self._tools.values():
                ...
                if (
                    name_pattern
                    and name_pattern.lower() not in tool.metadata.tool_name.lower()
                ):
                    continue
