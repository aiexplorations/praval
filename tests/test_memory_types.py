...
class TestMemoryType:
    ...
    def test_memory_type_invalid_string(self):
        ...
        with pytest.raises(
            ValueError, match="'invalid_type' is not a valid MemoryType"
        ):
...
class TestMemoryQuery:
    ...
    def test_memory_query_with_agent_filter(self):
        ...
        query = MemoryQuery(
            query_text="agent specific query", agent_id="specific_agent"
        )
    ...
    def test_memory_query_empty_memory_types_becomes_all(self):
        ...
        query = MemoryQuery(query_text="all types query", memory_types=None)
    ...
    def test_memory_query_single_memory_type(self):
        ...
        query = MemoryQuery(
            query_text="single type query", memory_types=[MemoryType.SHORT_TERM]
        )
...
class TestMemorySearchResult:
    ...
    def test_memory_search_result_basic_creation(self):
        ...
        result = MemorySearchResult(
            entries=entries, scores=scores, query=query, total_found=10
        )
    ...
    def test_memory_search_result_empty(self):
        ...
        result = MemorySearchResult(entries=[], scores=[], query=query, total_found=0)
    ...
    def test_memory_search_result_get_best_match_with_results(self):
        ...
        result = MemorySearchResult(
            entries=entries, scores=scores, query=query, total_found=3
        )
    ...
    def test_memory_search_result_get_above_threshold_default(self):
        ...
        result = MemorySearchResult(
            entries=entries, scores=scores, query=query, total_found=5
        )
    ...
    def test_memory_search_result_get_above_threshold_exact_match(self):
        ...
        result = MemorySearchResult(
            entries=entries, scores=scores, query=query, total_found=2
        )
...
class TestIntegrationScenarios:
    ...
    def test_memory_query_with_all_memory_types(self):
        ...
        # Query for all types
        query = MemoryQuery(query_text="all types test", memory_types=list(MemoryType))
    ...
    def test_temporal_query_integration(self):
        ...
        result = MemorySearchResult(
            entries=matching_entries, scores=[0.85], query=query, total_found=1
        )
