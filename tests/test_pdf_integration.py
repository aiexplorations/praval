...
from praval.memory.memory_types import MemoryType
...
class TestPDFIntegration:
    ...
    def test_create_and_index_real_pdf(self):
        ...
        pdf_content = [
            ...
            "",
            (
                "Deep Q-Networks (DQN) represent a significant advancement "
                "in reinforcement learning."
            ),
            (
                "The algorithm combines Q-learning with deep neural network"
                "s to handle complex state spaces."
            ),
            "",
            ...
            "",
            (
                "The Rainbow algorithm further improves upon DQN by combini"
                "ng multiple enhancements:"
            ),
            ...
            "",
            (
                "These improvements lead to more sample-efficient and stabl"
                "e learning in various environments."
            ),
        ]
    ...
    def test_knowledge_base_indexing_real_pdf(self):
        ...
        dqn_content = [
            ...
            (
                "We present the first deep learning model to successfully l"
                "earn control policies"
            ),
            (
                "directly from high-dimensional sensory input using reinfor"
                "cement learning."
            ),
            (
                "The model is a convolutional neural network, trained with "
                "a variant of Q-learning,"
            ),
            (
                "whose input is raw pixels and whose output is a value func"
                "tion estimating future rewards."
            ),
        ]
        ...
        ppo_content = [
            ...
            (
                "We propose a new family of policy gradient methods for rei"
                "nforcement learning,"
            ),
            (
                "which alternate between sampling data through interaction "
                "with the environment"
            ),
            (
                "and optimizing a surrogate objective function using stocha"
                "stic gradient ascent."
            ),
            (
                "PPO strikes a balance between ease of implementation, samp"
                "le complexity, and ease of tuning."
            ),
        ]
