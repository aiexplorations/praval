...
class TestMemoryManagerErrorHandling:
    ...
    def test_persistent_storage_error_handling(self):
        ...
        with (
            patch("praval.memory.memory_manager.EmbeddedVectorStore") as mock_embedded,
            ...
            manager = MemoryManager(agent_id="error_test_agent", backend="chromadb")
    ...
    def test_retrieve_memory_with_vector_store_caching(self):
        ...
        with (
            ...
            manager = MemoryManager(agent_id="retrieval_agent", backend="chromadb")
            ...
            mock_short_term_instance.retrieve.assert_called_once_with(
                "vector_memory_123"
            )
    ...
    def test_search_memories_error_handling(self):
        ...
        with (
            ...
            manager = MemoryManager(agent_id="search_error_agent", backend="chromadb")
...
class TestMemoryManagerSemanticIntegration:
    ...
    def test_store_knowledge_with_semantic_subsystem(self):
        ...
        with (
            ...
            manager = MemoryManager(agent_id="semantic_agent", backend="chromadb")
    ...
    def test_store_knowledge_fallback_to_basic_storage(self):
        ...
        with patch("praval.memory.memory_manager.ShortTermMemory") as mock_short_term:
            ...
            manager = MemoryManager(agent_id="fallback_agent", backend="memory")
    ...
    def test_get_domain_knowledge_with_semantic_subsystem(self):
        ...
        with (
            ...
            manager = MemoryManager(agent_id="domain_agent", backend="chromadb")

            result = manager.get_domain_knowledge(
                agent_id="domain_agent", domain="ai", limit=10
            )
        ...
        with patch("praval.memory.memory_manager.ShortTermMemory") as mock_short_term:
            ...
            test_entries = [
                MemoryEntry(
                    ...
                    agent_id="test",
                    memory_type=MemoryType.SEMANTIC,
                    content="Fallback knowledge",
                    metadata={},
                )
            ]

            search_result = MemorySearchResult(
                entries=test_entries, scores=[0.8], query=Mock(), total_found=1
            )
            ...
            result = manager.get_domain_knowledge(
                agent_id="fallback_agent", domain="test_domain", limit=5
            )
...
class TestMemoryManagerUtilityMethods:
    ...
    def test_clear_agent_memories_with_vector_store(self):
        ...
        with (
            ...
            manager = MemoryManager(agent_id="clear_test_agent", backend="chromadb")

            manager.clear_agent_memories("target_agent")

            # Should clear both short-term and persistent memory
            mock_short_term_instance.clear_agent_memories.assert_called_once_with(
                "target_agent"
            )
            mock_embedded_instance.clear_agent_memories.assert_called_once_with(
                "target_agent"
            )
    ...
    def test_clear_agent_memories_error_handling(self):
        ...
        with (
            ...
            # Setup mocks
            mock_embedded_instance = Mock()
            mock_embedded_instance.clear_agent_memories.side_effect = Exception(
                "Clear error"
            )
            mock_embedded.return_value = mock_embedded_instance
            ...
            manager = MemoryManager(agent_id="clear_error_agent", backend="chromadb")
    ...
    def test_get_memory_stats_with_vector_store_error(self):
        ...
        with (
            ...
            manager = MemoryManager(agent_id="stats_error_agent", backend="chromadb")
    ...
    def test_health_check_all_systems(self):
        ...
        with (
            ...
            manager = MemoryManager(agent_id="health_agent", backend="chromadb")
    ...
    def test_health_check_vector_store_unhealthy(self):
        ...
        with (
            ...
            manager = MemoryManager(agent_id="unhealthy_agent", backend="chromadb")
    ...
    def test_knowledge_base_indexing_error(self):
        ...
        with (
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                # Setup mocks
                mock_embedded_instance = Mock()
                mock_embedded_instance.index_knowledge_files.side_effect = Exception(
                    "Indexing error"
                )
                mock_embedded.return_value = mock_embedded_instance
...
class TestMemoryManagerAdvancedFeatures:
    ...
    def test_get_conversation_context_episodic_fallback(self):
        ...
        with patch("praval.memory.memory_manager.ShortTermMemory") as mock_short_term:
            ...
            manager = MemoryManager(agent_id="fallback_conv_agent", backend="memory")

            result = manager.get_conversation_context("test_agent", turns=5)

            assert result == test_memories
            mock_short_term_instance.get_recent.assert_called_once_with(
                agent_id="test_agent", limit=5
            )
    ...
    def test_should_store_long_term_logic(self):
        ...
        with patch("praval.memory.memory_manager.ShortTermMemory") as mock_short_term:
            ...
            manager = MemoryManager(agent_id="long_term_agent", backend="memory")
    ...
    def test_combine_search_results_deduplication(self):
        ...
        with patch("praval.memory.memory_manager.ShortTermMemory") as mock_short_term:
            ...
            manager = MemoryManager(agent_id="combine_agent", backend="memory")
    ...
    def test_shutdown_procedure(self):
        ...
        with patch("praval.memory.memory_manager.ShortTermMemory") as mock_short_term:
            ...
            manager = MemoryManager(agent_id="shutdown_agent", backend="memory")
