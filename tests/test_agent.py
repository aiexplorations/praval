...
class TestAgentInitialization:
    ...
    def test_agent_initialization_with_config(self):
        ...
        config = {"provider": "anthropic", "temperature": 0.7, "max_tokens": 1000}
...
class TestAgentProviderIntegration:
    ...
    def test_cohere_provider_auto_detection(self):
        ...
        with patch.dict("os.environ", {"COHERE_API_KEY": "test_key"}, clear=True):
            agent = Agent("assistant")
    ...
    def test_no_provider_available_raises_error(self):
        ...
        with patch.dict("os.environ", {}, clear=True):
            with pytest.raises(
                ProviderError, match="No LLM provider credentials found"
            ):
                Agent("assistant")
