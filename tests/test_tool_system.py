...
class TestToolRegistry:
    ...
    def setup_method(self):
        ...
        self.multiply_metadata = ToolMetadata(
            tool_name="multiply", owned_by="calculator", category="math"
        )
        self.shared_metadata = ToolMetadata(
            tool_name="shared_tool", shared=True, category="utility"
        )
    ...
    def test_get_registry_stats(self):
        ...
        # Categories: "general" (add_tool default), "math" (multiply_tool), "utility"
        # (shared_tool)
...
class TestToolDecorator:
    ...
    def test_tool_auto_description(self):
        ...
        assert (
            tool_instance.metadata.description
            == "This is a sample function for testing."
        )
